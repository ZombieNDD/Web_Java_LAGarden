								...
								<li class="mb-2"><a class="dropdown-item border-radius-md"
									href="javascript:;">
										<div class="d-flex py-1">
											<div class="my-auto">
												<img
													src="${pageContext.servletContext.contextPath}/adminResource/img/team-2.jpg"
								...
								<li class="mb-2"><a class="dropdown-item border-radius-md"
									href="javascript:;">
										<div class="d-flex py-1">
											<div class="my-auto">
												<img
													src="${pageContext.servletContext.contextPath}/adminResource/img/small-logos/logo-spotify.svg"
